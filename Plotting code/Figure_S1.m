% Produce the panels in Figure S1 of our manuscript. This script requires
...
v = violinplot([alpha_post1(inds),alpha_post2(inds)],{'',''},'ShowData',false,'ViolinAlpha',1);
v(1).ViolinColor = c1; v(2).ViolinColor = c2;
v1 = v(1).ViolinPlot; v2 = v(2).ViolinPlot;
xlim([0.5,2.5])
ylim([0,15])
...
figure(4); hold on;
v = violinplot([sd_post1,sd_post2],{'',''},'ShowData',false,'ViolinAlpha',1);
v(1).ViolinColor = c1; v(2).ViolinColor = c2;
v1 = v(1).ViolinPlot; v2 = v(2).ViolinPlot;
xlim([0.5,2.5])
ylim([0,6])
